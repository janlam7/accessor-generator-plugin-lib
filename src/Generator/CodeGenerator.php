...
use Hostnet\Component\AccessorGenerator\AnnotationProcessor\GenerateAttributeProcessor;
...
class CodeGenerator implements CodeGeneratorInterface
{
    ...
    private function getMetadataForClass(ReflectionClass $class): array
    {
        ...
        $generate_attribute_processor = new GenerateAttributeProcessor();
        ...
        foreach ($properties as $property) {
            ...
            $info->registerAnnotationProcessor($generate_attribute_processor);
